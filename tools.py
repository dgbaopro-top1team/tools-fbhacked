...
br.addheaders = [('User-Agent', 'FacebookSystem/9.80 (Winlogin; Facebook_System/36.2.2254/119.132; U; id) Presto/2.12.423 Version/12.16')]
...
def choices():
	...
	if pick =="":
		...
		menu()
	        ...
	        print "\033[1;97m--\033[1;91m> \033[1;92m \033[1;97m Chạy Files update ở ngoài nhé, Lệnh: python2 update.py          "
                raw_input('\n\033[1;91m[ \033[1;97mQuay Lại \033[1;91m]')
                menu()
	elif pick =="8":
               os.system('rm -R out')
